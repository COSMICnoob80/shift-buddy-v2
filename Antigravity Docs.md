...
-   side\_navigation
-   [Home](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/home)
\>-   Getting Started
...
![Update Available](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/restart-to-update.png)

## Basic Navigation

The Agent Manager can be opened from the Editor via the button on the top bar or via keyboard shortcut `Cmd + E`:

![Editor Open Agent Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor-open-agent-manager.png)
...
![Agent Manager Open Editor](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent-manager-open-editor.png)
...
-   side\_navigation
-   [Agent](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent)
\>-   Models
...
![Model Selector Drop Down](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/model-selector.png)
...
Learn more about reasoning model rate limits in [our plans page](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/plans).
...
-   **Gemini 2.5 Pro UI Checkpoint**: Used by the [browser subagent](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser-subagent) to actuate the browser, such as clicking, scrolling, or filling in input.
...
-   Planning: Agent can plan before executing tasks. Use for deep research, complex tasks, or collaborative work. In this mode, the Agent organizes its work in [task groups](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/task-groups), produces [Artifacts](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/artifacts), and takes other steps to thoroughly research, think through, and plan its work for optimal quality.
...
![Settings Review Policy Proceed](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent/settings-review-policy-proceed.png)
...
![Settings Review Policy Manual](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent/settings-review-policy-manual.png)
...
Allow Agent to view and edit files outside of the current workspace. By default, the Agent only has access to the files in the workspace and in the application’s root folder `~/.antigravity/`, which contains [Artifacts](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/artifacts), [Knowledge Items](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/knowledge), and other Antigravity-specific data.
...
To execute a workflow, simply invoke it in Agent using the /workflow-name command. You can call other Workflows from within a workflow! For example, /workflow-1 can i-   side\_navigation
-   [Agent](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent)
\>-   Rules / Workflows
...
You can also ask Agent to generate Workflows for you! This works particularly well after manually working with Agent through a series of steps since it can use the conversation history to create the Workflow.nclude instructions like “Call /workflow-2” and “Call /workflow-3”. Upon invocation, Agent sequentially processes each step defined in the workflow, performing actions or generating responses as specified.
...
![Task Group](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent/task-group.png)
...
![Task Group Clicked Pill](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent/task-group-clicked-pill.png)
...
![Task Group Expanded](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent/task-group-expanded.png)
...
![Task Group Pending](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent/task-group-pending.png)
...
![Sandbox settings toggles](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/sandbox-settings-toggle.png)
...
![File system operation blocked by sandbox](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/sandbox-filesystem-denied.png)
...
![Sandbox network denial example](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/sandbox-network-denied.png)
...
![Bypass Sandbox option in Request Review mode](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/sandbox-bypass-option.png)
...
![Sandbox settings in strict mode](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/sandbox-secure-mode-settings.png)
...
Artifacts are produced while the Agent is in [Planning mode](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-modes-settings), and appear in both the [Agent Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-manager) and [Editor](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/editor) views, though the former is optimized for displaying, organizing, and managing Artifacts.
...
-   side\_navigation
-   [Artifacts](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/artifacts)
\>-   Task List
...
![Task List](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-task.png)
...
![Artifact Implementation Plan](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-implementation-plan.png)
...
![Artifact Implementation Plan Proceed](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-implementation-plan-proceed.png)
...
![Artifact Implementation Plan Comments](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-implementation-plan-comments.png)
...
![Artifact Implementation Plan Submit Comments](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-implementation-plan-submit-comments.png)
...
![Artifact Implementation Plan Proceeded](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-implementation-plan-proceeded.png)
...
![Walkthrough](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-walkthrough.png)
...
![Walkthrough with Image](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/artifact-walkthrough-image.png)


[](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/)

Built for developers in the agent-first era

Explore how Google Antigravity helps you build

[See overview](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/use-cases)

[workspaces Professional keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/use-cases/professional)[code\_blocks Frontend keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/use-cases/frontend)[stacks Fullstack keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/use-cases/fullstack)

Everything you need to stay up-to-date and get help

[Documentation keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs) [Changelog keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/changelog) [Support keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/support) [Press keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/press) [Releases keyboard\_arrow\_right](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/releases)

[Home expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/home)

[Getting Started](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/get-started)

[Agent expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent)

[Models](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/models)

[Agent Modes / Settings](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-modes-settings)

[Rules / Workflows](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/rules-workflows)

[Skills](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/skills)

[Task Groups](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/task-groups)

[Browser Subagent](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser-subagent)

[Strict Mode](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/strict-mode)

[Sandboxing](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/sandbox-mode)

Tools expand\_more

[MCP](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/mcp)

[Artifacts expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/artifacts)

[Task List](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/task-list)

[Implementation Plan](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/implementation-plan)

[Walkthrough](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/walkthrough)

[Screenshots](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/screenshots)

[Browser Recordings](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser-recordings)

[Knowledge](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/knowledge)

[Editor expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/editor)

[Tab](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/tab)

[Command](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/command)

[Agent Side Panel](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-side-panel)

[Review Changes + Source Control](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/review-changes-editor)

[Agent Manager expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-manager)

[Workspaces expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/workspaces)

[Playground](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/playground)

[Inbox](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/inbox)

[Conversation View expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/conversation-view)

[Browser Subagent View](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser-subagent-view)

[Panes](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/panes)

[Review Changes + Source Control](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/review-changes-manager)

[Changes Sidebar](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/changes-sidebar)

[Terminal](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/terminal)

[Files](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/files)

[Browser expand\_more](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser)

[Chrome Extension](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/chrome-extension)

[Allowlist / Denylist](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/allowlist-denylist)

[Separate Chrome Profile](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/separate-chrome-profile)

[Plans](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/plans)

[Settings](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/settings)

[FAQ](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/faq)
...
![Browser Screenshot Capture Tool](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/browser-screenshot-capture.png)

All screenshots are saved as image artifacts and can be commented on to give feedback to the agent.

![Browser Screenshot Artifact](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/browser-screenshot-artifact.png)
...
![Browser Recording Capture Tool](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/browser-recording-capture.png)
...
![Browser Recording Artifact](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/browser-recording-artifact.png)
...
![Knowledge View](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/artifacts/knowledge-view.png)
...
Much of this editor is designed to feel the same as prior experiences you may have had. You can open files up, tab through them, edit them directly, get suggestions with [Tab](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/tab), and work with an agent on [smaller](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/command) or [larger tasks](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-side-panel). When you’re done, you can review your changes and interface with your preferred [source control](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/review-changes-editor). You can also still download extensions from the Open VSX marketplace to augment your experience, through further syntax highlighting, source control integrations, or other additions.

![Editor Screenshot](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/editor.png)


-   side\_navigation
-   [Editor](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/editor)
\>-   Tab
...
![Supercomplete](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/supercomplete.png)
...
![Tab-to-Jump](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/tab_to_jump.png)
...
![Tab-to-Import](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/tab_to_import.png)
...
![Command in Editor](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/command_editor.png)
...
![Command in Terminal](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/command_terminal.png)
...
Use the panel on the right side of the editor to work directly with the agent. You can spin up new conversations, attach images, switch [agent modes](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-modes-settings), and select between [different models](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/models).

![Editor Agent Panel](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/editor_agent_panel.png)
...
![Editor Agent Panel](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/agent_panel_toolbar.png)
...
Once the agent has begun writing code within a conversation, you’ll see a `Review Changes` section within the Agent panel’s [bottom toolbar](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-side-panel). Clicking it will open up a pane within your editor where you can scroll through all of the changes you and your agent made within the conversation.

![Editor Review Changes](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/review_changes_editor.png)

Just like with artifacts, you can comment on any of the file diffs to communicate with the agent.

![Editor Source Control](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/editor/source_control_editor.png)

[Agent Side Panel](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-side-panel)

[Agent Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-manager)
...
![Agent Manager Editor](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent_manager_editor.png)
...
![Switch Workspaces](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/workspaces/switch_workspace.png)
...
![Start Conversation Within Workspace](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/workspaces/start_within_workspace.png)


-   side\_navigation
-   [Agent Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-manager)
\>-   [Workspaces](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/workspaces)
\>-   Playground
...
![Playground Button](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/playground/playground_button.png)

From here, you can send a message as you would normally.

![Playground Send Message](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/playground/playground_send.png)
...
![Playground Persist](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/playground/playground_persist.png)

Clicking on the move button in the top bar will pop up the following modal:

![Playground Move Modal](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/playground/playground_move.png)
...
![Inbox Overview](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/inbox/basic_inbox.png)
...
![Continue Conversation](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/inbox/continue_conversation.png)
...
The [Agent Panel](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-side-panel) takes center stage in the agent manager. As the agent makes progress, you'll be able to follow along with what it's doing. To toggle off this follow-along mode, simply hit the `Following` button at the top right of the conversation.

![Follow Along Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/follow_along_manager.png)
...
-   side\_navigation
-   [Agent Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-manager)
\>-   [Conversation View](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/conversation-view)
...
![Browser Subagent View](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/browser-subagent-view.png)
...
You can open files, [artifacts](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/artifacts), knowledge items, and other content directly within the manager in panes that persist per-conversation. In order to open up a pane, simply open up the quick picker (by hitting CMD+P on Mac or CTRL+P on Windows/Linux) and select a resource. You can also hit the "+" from within a conversation's header.

![Manager New Tab](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent-manager/manager_new_tab.png)![Manager File Picker](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent-manager/manager_file_picker.png)
...
![Manager Split Pane](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent-manager/manager_split_pane.png)
...
Just as in the [editor](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/review-changes-editor), you can easily review the work you and your agent have collaborated on from within the manager.
...
![Review Changes Manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/review_changes_manager.png)
...
![Manager Source Control](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/manager_source_control.png)
...
Similar to the toolbar at the bottom of the editor's [Agent Panel](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/agent-side-panel), the Changes Sidebar in the manager offers a quick way to see what [artifacts](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/artifacts) the agent has created and what files it has modified within a conversation.
...
![Aux Sidebar](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/aux-sidebar.png)
...
![agent-manager-terminal](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/agent-manager-terminal.png)
...
As you open up [file panes](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/panes) within the manager, you can also leave comments for the agent to highlight specific points.

![File commenting manager](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/file_commenting_manager.png)
...
Using a [subagent](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser-subagent), Antigravity can operate on the browser as it sees fit, as well as [recording its actions](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser-recordings) and presenting select screenshots and videos as [artifacts](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/screenshots).

To isolate the Antigravity agent from your normal browsing, it runs in a separate browser profile. This means that it will show up as a separate application in your dock and nothing will be signed in. You can read more about this in the [Separate Chrome Profile](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/separate-chrome-profile) section.
...
![Enable Browser Tools](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/enable_browser_tools.png)
...
![Chrome Binary Path](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/chrome_binary_path.png)


-   side\_navigation
-   [Browser](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/browser)
\>-   Chrome Extension
...
![Allowlist](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/browser-allowlist.png)
...
![Always Allow](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/always-allow-url.png)
...
![Browser Profile](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/assets/image/docs/browser/browser-profile.png)
...
At this moment, Google Antigravity is available with [terms](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/terms) to individual accounts derived from Google's terms of service, and in preview (pre-general availability) to teams derived from Section 5 of the General Service Terms in Google Cloud's enterprise terms of service.
...
Please refer to the [Terms of Service](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/terms). You may opt out of data collection at any point from the Settings panel.
...
Check out the communities on our [Support page](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/support).

## What are the model rate limits?

Please see more details in the docs on [Plans](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/docs/plans).

## Why can’t I use third party software (e.g. Claude Code, OpenClaw, OpenCode) with my Antigravity login?

Using third party software, tools, or services to access Antigravity is a violation of our [Terms of Service](moz-extension://06ec2d0f-8c77-4df6-a2fa-4752e5e56a26/terms), and severely degrades the experience for legitimate product users. Such actions may be grounds for suspension or termination of your account. If you would like to use a third party coding agent with Gemini, we recommend using a Vertex or AI Studio API key.
