...
## Active Technologies
- Python 3.12+ (api/), TypeScript 5.x strict (web/) + FastAPI 0.115+, Pydantic v2, SQLAlchemy 2.0 async + asyncpg, Alembic, passlib[bcrypt], python-jose[cryptography], slowapi, structlog, pydantic-settings; Next.js 14 App Router, Tailwind, Playwright (001-p0-foundation-auth)
- PostgreSQL 16 (primary), Redis 7 (wired, unused in P0) (001-p0-foundation-auth)
